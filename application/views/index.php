                ...
                <div class="row align-items-center">
                    <div class="col-sm-12 col-md-6">
                        <div class="hero-content">
                            <div class="hero-text">
                                <p>Hi!, Saya</p>
                                <h1>Rizky Maulidi M</h1>
                                <h2></h2>
                                <div class="typed-text">Web Designer, Graphic Designer, Front End Developer, Apps Designer, Apps Developer</div>
                            </div>
                            <div class="hero-btn">
                                <a class="btn" href="">Donwload Portofolio</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6 d-none d-md-block">
                        <div class="hero-image">
                            <img src="img/hero3.png" alt="Hero Image" width="200%">
                        </div>
                    </div>
                </div>
            </div>
